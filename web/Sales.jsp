        ...
        <div class="dtls">
            <center>               
                <form action="saless" name="myfrm">
                    <font size="4px" face="Lucida Calligraphy" color="#894d10">Sale ID</font> <input type="text" name="sid" placeholder="Enter Sales ID" value='<%=request.getAttribute("slid")%>'/><br/><br/>
                    ...
                    <font size="4px" face="Lucida Calligraphy" color="#894d10">Product Quantity</font> <input type="text" name="pqty" placeholder="Enter Product Quantity" value='<%=request.getAttribute("prqty")%>'/><br/><br/>
